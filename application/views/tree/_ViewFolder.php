...
<div class="card mb-3">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div>
                        <div class="btn create" style="background-color: #1e7e34
; color: #FFFFFF;" role="button" href="#" data-id="<?= $id; ?>" data-toggle="modal" data-target="#customModal"><span class="btn-label"><i class="fa fa-plus"></i></span>New</div>
                        <p> 
                    </div>
...
; color: #FFFFFF;">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align= "center">
                                        <a href="<?php echo site_url('tree/delete')?>/<?= $h->u_ID ?>" title="Delete" onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-fw fa-window-close" style="color: #000000;"></i></a>
                                    </td>  
                                </tr>
                            <?php } ?>
                            </tbody>
